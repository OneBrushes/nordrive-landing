    ...
    <section className="py-12 md:py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground md:text-base">Ejemplo real para un VW Golf GTI 2017</p>
        </motion.div>
        <div className="grid md:grid-cols-3 gap-4 max-w-2xl mx-auto mb-4">
          <motion.div initial={{opacity:0,y:20}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration:0.5, delay:0.1}} className="bg-card/70 rounded-xl flex flex-col items-center justify-center py-8 px-5 border border-border">
            ...
            <span className="text-3xl font-bold mt-3 mb-2 line-through text-gray-400">25.500 €</span>
          </motion.div>
        ...
        <div className="text-xs text-muted-foreground mt-6 text-center max-w-lg mx-auto">*Datos reales extraídos de operaciones realizadas y precios medios de webs oficiales de concesionarios españoles en 2025. El ahorro puede variar según modelo y condiciones.</div>
      </div>
    </section>
  )
}
